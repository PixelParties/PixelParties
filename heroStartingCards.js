...
const HERO_CARD_SETS = {
    ...
    'Ingo': ['SummoningMagic', 'Wealth',  'BurnedContract', 'SummoningCircle', 'DarkDeal', 'SoulTransmigrationRitual', 'TheRootOfAllEvil', 'RitualChamber'],
    ...
    'Riffel': ['Inventing', 'FutureTechGun', 'FutureTechBazooka', 'FutureTechLaserCannon', 'FutureTechPotionLauncher', 'FutureTechBomb', 'ArmsTrade', 'FutureTechBarrage'],
